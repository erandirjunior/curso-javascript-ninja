// Expressões regulares -> manipulam strings, é um tipo primitivo

var regex = /m/; //undefined
regex; ///m/

// RegExp() -> objeto de expressão regular

// match() -> tentar fazer o match da string com a expressão regular
...
text.match(/m/g); //(13) ["m", "m", "m", "m", "m", "m", "m", "m", "m", "m", "m", "m", "m"]
