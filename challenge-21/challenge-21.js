(function(window, document) {
	...
	*/
	...
	var $inputStart = document.querySelector('[data-js="start"]');
	var $inputStop = document.querySelector('[data-js="stop"]');
	var $inputReset = document.querySelector('[data-js="reset"]');
